        ...
        <div className='relative transition-all'>
            ...
            <div className={`fixed top-0 right-0 w-[300px] h-screen transition-all ${isOpen ? 'mr-0' : 'mr-[-300px]'} bg-white p-4 shadow-2xl`}>
                ...
                <div className='flex gap-2 mb-2'>
                    <button className='bg-gray-200 px-1 py-4 rounded-md hover:bg-gray-300 disabled:hover:bg-gray-200 disabled:opacity-50' onClick={() => setCurrPage(prev => Number(prev) - 1)} disabled={currPage <= 1}><Iconify icon='mingcute:left-line' className='text-2xl' /></button>
                    ...
                    <button className='bg-gray-200 px-1 py-4 rounded-md hover:bg-gray-300 disabled:hover:bg-gray-200 disabled:opacity-50' onClick={() => setCurrPage(prev => Number(prev) + 1)} disabled={currPage >= pageList.length}><Iconify icon='mingcute:right-line' className='text-2xl' /></button>
                </div>

                <div className='flex gap-2 mb-2'>
                    <button className='bg-gray-200 px-1 py-4 rounded-md hover:bg-gray-300 disabled:hover:bg-gray-200 disabled:opacity-50' onClick={() => setChapterIndex(prev => Number(prev) - 1)} disabled={chapterIndex <= 0}><Iconify icon='mingcute:left-line' className='text-2xl' /></button>
                    ...
                    <button className='bg-gray-200 px-1 py-4 rounded-md hover:bg-gray-300 disabled:hover:bg-gray-200 disabled:opacity-50' onClick={() => setChapterIndex(prev => Number(prev) + 1)} disabled={chapterIndex >= chapterIdList.length}><Iconify icon='mingcute:right-line' className='text-2xl' /></button>
                </div>
